...
\end{table}
\footnotetext{http://de.wikipedia.org/wiki/Oberflächenspannung}
\subsection{Viskosität}
\begin{figure}
\centering
\include{Viskositaet}
...
\begin{align*}
\sigma_\eta&=\sqrt{\sigma_{\Delta p}^2\cdot \left(\frac{\pi r^4}{8\dot V l}\right)^2+\sigma_{r}^2\cdot\left(\frac{\pi~\Delta p\cdot 4 r^3}{8\dot V l}\right)^2+\sigma_{\dot V}^2\cdot \left(\frac{\pi~\Delta p r^4}{8\dot{V}^2 l}\right)^2+\sigma_{l}^2\cdot \left(\frac{\pi~\Delta p r^4}{8\dot{V} l^2}\right)^2}\\
\sigma_{\dot V}&=\sqrt{}
\end{align*}
Damit ergeben sich Werte für die Viskosität von Wasser von 
