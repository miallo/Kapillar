...
\begin{align}
	\sigma_{\eta}=\frac{g \cdot r^{3} \cdot \rho}{8 \cdot R^{3} \cdot l^{2} \cdot m^{2}} \cdot \sqrt{16 \cdot R^{2} \cdot l^{2} \cdot m^{2} \cdot \sigma_{r}^{2} + R^{2} \cdot l^{2} \cdot r^{2} \cdot \sigma_{m}^{2} + R^{2} \cdot m^{2} \cdot r^{2} \cdot \sigma_{l}^{2} + 4 \cdot l^{2} \cdot m^{2} \cdot r^{2} \cdot \sigma_{R}^{2}}
\end{align}
Es ergibt sich ein Wert von $\eta=(0.00060 \pm 0.00007)\si{\Pa\s}$. Die Diskrepanz der beiden Werte der Geradensteigung und der Tabelle \ref{tbl:visko2b} ist dadurch zu erklären, dass bei dem Fit auch der Wert der Zeit $t=74.48$s mit berücksichtigt wurde, den wir aus Tablelle explizit herausgenommen haben (s. Diskussion). Andernfalls käme man auf ein identisches Ergebnis.\\
