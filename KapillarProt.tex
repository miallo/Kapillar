...
Der Literaturwert\footnote{Quelle: www.uni-magdeburg.de/isut/LSS/Lehre/Arbeitsheft/IV.pdf, 22.06.2014, 13 Uhr} liegt bei Wasser für $\SI{25}{\celsius}$ bei 0.00089 \si{\Pa\s} was 25\% größer ist, als die Tabellenmesswerte, welche für $(27.5\pm 1)^\circ$C aufgenommen wurden. Allerdings ist nach eben dieser Quelle die Viskosität von Wasser bei $30^\circ$C nurnoch bei 0.000798 \si{\Pa\s}, was nurnoch 12\% größer ist, als unser Wert.
\begin{table}[!h]
\centering
\begin{tabular}{|l|l|}
 \hline
